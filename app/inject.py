...
DB_USER = os.getenv("DB_USER", "codez")
...
conn = psycopg2.connect(
    host=HOST, port=PORT, user=DB_USER, password=PASSWORD, database=DATABASE
)
    ...
    while True:
        ...
        cursor.execute(
            ...
            (
                ...
                content["contents"]["total_lines"],
                json.dumps(content["contents"]["lines"]),
            ),
        )
