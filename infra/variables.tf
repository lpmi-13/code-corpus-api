...
// this is the apex zone for codecorpus.net
variable "apex_hosted_zone_id" {
...
variable "apex_domain_for_certificate" {
  description = "this is the apex domain you want a certificate for"
}
